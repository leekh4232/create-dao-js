...
class DBPoolHelper {
    ...
    constructor(connectionInfo) {
        ...
        this.pool.on('connection', (connection) => {
            console.info(` >> Database Connected [threaId=${connection.threadId}]`);
        ...
        this.pool.on('acquire', (connection) => {
            console.info(` >> Connection pool activate [threaId=${connection.threadId}]`);
        });

        this.pool.on('release', (connection) => {
            console.info(` >> Connection pool deactivate [threaId=${connection.threadId}]`);
        });
    }
